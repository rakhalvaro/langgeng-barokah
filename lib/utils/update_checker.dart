...
class _UpdateDialogState extends State<_UpdateDialog> {
  ...
  Future<void> _downloadAndInstall() async {
    ...
    try {
      ...
      final apkPath = '${tempDir.path}/berkah_telor_update.apk';
      ...
      content: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.system_update, color: kPrimary, size: 36),
          ),
          ...
          Container(
            ...
            child: Text(
              widget.changelog,
              style:
                  GoogleFonts.poppins(fontSize: 13, color: Color(0xFF085041)),
            ),
          ),
          ...
          if (_isDownloading) ...[
            ...
            Text(
              _statusText,
              style:
                  GoogleFonts.poppins(fontSize: 12, color: Color(0xFF085041)),
